                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>Hello My Baby💖 เป็นไงบ้างชอบไหมคะ เค้าทำให้เป็นของขวัญครบรอบสี่เดือนของเรานะ แต่จริงๆคือเราอยู่ด้วยกันมาครึ่งปีได้แล้วมั้ง เป็นไปได้อยากให้เราอยู่ไปด้วยกันไปอีกหลายๆปี จนเรามีบ้านมีรถมีหมามีแมวมีลูกผู้หญิงที่เหมือนเธอกับเค้าและอะไรอีกหลายๆอย่างที่เราเคยคุยกันไว้ ครึ่งปีที่ผ่านมาเค้าขอบคุณเธอมากจริงๆ และอยากให้รู้ไว้ว่าเค้าจะคอยซัพพอร์ตเธออยู่ตรงนี้เสมอ เค้ารักเธอนะ</p>
                                    </div>
